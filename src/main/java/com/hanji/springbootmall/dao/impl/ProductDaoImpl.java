package com.hanji.springbootmall.dao.impl;

import com.hanji.springbootmall.constant.ProductCategory;
import com.hanji.springbootmall.dao.ProductDao;
...
import com.hanji.springbootmall.rowmapper.ProductRowMapper;
...
public class ProductDaoImpl implements ProductDao {
    ...
    public List<Product> getProducts(ProductQueryParams productQueryParams) {
        ...
        if (productQueryParams.getSearch() != null) {
            sql += " AND product_name LIKE :search"; // % 不能寫在這
